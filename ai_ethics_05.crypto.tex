...
% Lecture 5 color theme (cryptocurrency)
...
\setbeamercolor{structure}{fg=cryptoblue}
...
\setbeamercolor{block body}{bg=cryptoblue!10}
...
\mode<article>{
This lecture examines the political philosophy underlying cryptocurrency technologies. We begin by analyzing money as a social technology and exploring how different monetary systems embody different power relationships. Bitcoin and subsequent cryptocurrencies represent an attempt to create money independent of state control through cryptographic proof and decentralized consensus. We evaluate arguments both for and against cryptocurrency from perspectives including financial inclusion, individual liberty, environmental impact, and the appropriate role of state power in monetary systems. The debate over cryptocurrency regulation crystallizes fundamental questions about the relationship between technology, markets, and political authority.
}
