...
% ---------------------------------------------------------------------------
%  PROJECT OVERVIEW  |  DISCIPLINE KEY  |  QR CODE  (three-panel row)
% ---------------------------------------------------------------------------
...
\begin{minipage}[t]{0.12\linewidth}
  ...
  \qrcode[height=2.85cm]{https://brendanpshea.github.io/computing_ai_ethics/}\\[4pt]
  {\sffamily\fontsize{5.5}{7}\selectfont\textcolor{mPrimary}%
