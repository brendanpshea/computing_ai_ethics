...
\fancyfoot[L]{\sffamily\scriptsize\textcolor{mPrimary}{%
  \textbf{Computing \& AI Ethics} \textnormal{|} OER Conference 2026 \textnormal{|} Brendan Shea, PhD (RCTC)}}
...
\begin{tabular}{@{}lp{0.72\linewidth}@{}}
  ...
  \textbf{Quiz App} &
    Plain JavaScript, auto-graded, 20+ Qs; host on GitHub Pages \\[2pt]
  \textbf{Source Code} &
...
\vspace{14pt}
\noindent{\sffamily\bfseries\large\textcolor{mPrimary}{%
  \faComments\enspace Key Questions: Teaching AI Ethics Across the Curriculum}}\\[2pt]
\noindent\textcolor{mAccent}{\rule{\linewidth}{1.5pt}}
\vspace{5pt}
...
\begin{itemize}
  ...
  \item When a student submits AI-assisted work, who is responsible for its
    accuracy --- and what, if anything, remains of academic integrity once
    AI can produce a plausible answer to almost any assignment?
    \dtag{tagEDU}{EDU} \dtag{tagLA}{LA}
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item Open-source software and open-access publishing subvert traditional IP
    logic. What would a field that adopted open-access norms gain --- and
    what economic models would have to change?
    \dtag{tagSCI}{SCI} \dtag{tagEDU}{EDU} \dtag{tagIT}{IT}
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item Employers increasingly monitor keystrokes, location, and productivity
    metrics in real time. Does a legitimate interest in productivity ever
    justify this level of oversight --- and does remote work change the
    calculus? \dtag{tagBUS}{BUS} \dtag{tagHLTH}{HLTH} \dtag{tagIT}{IT}
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item Nurses, social workers, and therapists read subtle emotional and
    relational cues. How might AI tools that assist or monitor their decisions
    affect practitioner judgment, patient trust, and professional identity?
    \dtag{tagHLTH}{HLTH} \dtag{tagEDU}{EDU}
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item Predictive algorithms are used in bail, sentencing, and parole
    decisions. If a model is more accurate on average than a judge, is it
    ethically preferable --- even if it encodes historical racial disparities?
...
\begin{itemize}
  ...
  \item Companion robots are increasingly deployed in elder care. If a resident
    forms a strong bond with one, does the facility have an obligation to
    maintain it --- even when it becomes costly to do so?
    \dtag{tagHLTH}{HLTH} \dtag{tagBUS}{BUS} \dtag{tagLA}{LA}
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item Games use variable-reward schedules --- the same mechanism as slot
    machines --- to maximize play time. Do developers have an obligation to
    build in limits, especially for minors and vulnerable users?
    \dtag{tagBUS}{BUS} \dtag{tagHLTH}{HLTH} \dtag{tagEDU}{EDU}
\end{itemize}
\end{tcolorbox}
