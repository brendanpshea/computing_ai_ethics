...
\vspace{0.2em}
\textbf{Daniel Solove} \parencite{solove_understanding_privacy}: The problem isn't isolated data, but the ``aggregation problem.''
\end{frame}
...
\begin{itemize}
  \item A circular prison where a single guard in a \textbf{central tower} can observe all prisoners
  \item Prisoners \textbf{cannot see} whether they are being watched at any moment
  \item The key insight: prisoners \textbf{internalize} the gaze---they self-regulate even when not observed
  \item Michel Foucault used it to analyze \textbf{modern power and surveillance} in \textit{Discipline and Punish} (1975)
\end{itemize}
\end{block}
\begin{discussionbox}[Discussion]
...
\vspace{0.1em}
\textbf{Bruce Schneier} \parencite{schneier_data_goliath}: ``Too many wrongly characterize the debate as `security versus privacy.' The real choice is liberty versus control.''
\end{frame}
