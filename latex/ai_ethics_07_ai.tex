...
2025 & \textbf{Reasoning models}: capability starts scaling with thinking time at the moment of use, not just with training. Open-weight models match closed ones at a fraction of the cost \\
2026 & \textbf{Agents}: systems that operate software and act, rather than only answer. Release cycles compress to weeks \\
\bottomrule
\end{tabular}
\end{table}
...
In 2026, for the first time, labs and governments withheld systems \emph{because of what they could do}: one lab declined to release a model over its autonomous cyber-exploitation ability, and the US government asked another to stagger a rollout pending federal evaluation.
\end{alertblock}
