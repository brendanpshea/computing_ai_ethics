...
\begin{itemize}
  \item Technology is \textbf{not neutral}---it reflects and reinforces existing power structures
  \item The printing press and telegraph served \textbf{bourgeois} commercial interests
  \item Those who \textbf{own} the means of communication control public discourse
  \item ``The ruling ideas of each age have been the ideas of its ruling class''
\end{itemize}
\end{block}
\begin{discussionbox}[Discussion]
Who owns today's means of communication---and does ownership shape the message?
\end{discussionbox}
\end{column}
\begin{column}{0.47\textwidth}
\begin{figure}
...
\vspace{0.3em}
\begin{exampleblock}{\faQuoteLeft\hspace{0.5em}Hannah Arendt, \textit{The Origins of Totalitarianism}, Chapter 13 \parencite{arendt_origins}}
\small
