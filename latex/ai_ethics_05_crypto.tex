...
\begin{discussionbox}[Discussion]
Is cryptocurrency best understood as a financial technology, a political statement, or a speculative asset---or are these inseparable?
\end{discussionbox}
\end{frame}
...
\begin{frame}[shrink=10]{Bitcoin---The Original Cryptocurrency}
...
\begin{itemize}
    \item Maximum supply: 21 million BTC (ever); ``halving'' every $\sim$4 years reduces new supply
...
\scriptsize
Satoshi disappeared in 2011. Estimated holdings: $\sim$1.1 million BTC---roughly \textbf{5\% of all Bitcoin that will ever exist}, unmoved since 2010. (Inferred from patterns in early blocks, not proof of ownership.)
\end{alertblock}
\end{frame}
...
% Slide 39: CBDCs
\begin{frame}[shrink=12]{Central Bank Digital Currencies (CBDCs)---A Middle Path?}
...
\vspace{0.1em}
\textbf{Note the pattern}: all three countries that launched a retail CBDC struggle with adoption. Nigeria repositioned the eNaira as back-end infrastructure in 2026, while a \emph{privately} issued naira stablecoin gained traction voluntarily. Can adoption be mandated?}
\end{frame}
