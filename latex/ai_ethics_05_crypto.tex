...
\begin{itemize}
  \item Lydia (modern Turkey) issued the first \textbf{standardized metal coins} around 600 BCE
  \item Made from \textbf{electrum}---a naturally occurring gold-silver alloy
  \item Stamped by the state to \textbf{certify weight and purity}---an early form of trusted authority
  \item Enabled commerce between \textbf{strangers} who didn't know each other personally
\end{itemize}
\end{block}
\begin{exampleblock}{The Insight}
\small Coins solved the \textbf{double coincidence of wants} problem: you no longer had to find someone who wanted exactly what you had.
\end{exampleblock}
\end{column}
...
\begin{itemize}
  ...
  \item \textbf{Too heavy to move}---ownership transferred verbally, recorded in community memory
  \item A famous stone \textbf{sank at sea} during transport; its owner still ``owned'' it and the community accepted this
  \item Value based entirely on \textbf{social consensus}---not physical possession
\end{itemize}
\end{block}
\begin{alertblock}{The Parallel}
\small Bitcoin's blockchain is a \textbf{digital ledger of consensus}---just like the Yapese oral ledger, but recorded in cryptographic code.
\end{alertblock}
\end{column}
\begin{column}{0.47\textwidth}
\begin{figure}
