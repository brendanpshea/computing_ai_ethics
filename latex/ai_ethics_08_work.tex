...
% Slide 1: Title
\lecturetitleslide{images/fractal_08.png}


% ====================
% COLD OPEN
% ====================
% Sets up Arendt's labor / work / action distinction, which is the next slide.

\begin{frame}{Before We Begin: You Never Have to Work Again}
A relative you barely knew leaves you enough money to live comfortably for the rest of your life. It clears on \textbf{Monday}. Nobody will ever ask you to hold a job again.

\vspace{0.3em}
\textbf{Write down yes or no}: do you quit?

\begin{alertblock}{Now the real question}
Most people answer that one fast. The one that actually matters is: \textbf{what do you do on Tuesday?} Not the first week --- anyone can spend a week. The Tuesday after the novelty wears off.
\end{alertblock}

\begin{discussionbox}[Commit before we go on]
Say your Tuesday out loud. Then ask whether what you described is a \textbf{job}, and if not, why it was so easy to name something you would do for free and so hard to get paid for it.
\end{discussionbox}
\end{frame}
...
% Slide 4b: Marx on Alienated Labor
\begin{frame}[shrink=8]{Marx: The Four Alienations}
Arendt asks what work \emph{is}. Marx asks what happens when work \textbf{goes wrong} \parencite{marx_manuscripts}.

\vspace{0.2em}
\begin{conceptbox}[Alienation---Marx, 1844]
\small
Under industrial capitalism, the worker is separated from four things:
\begin{enumerate}
    \item \textbf{The product}: what you make belongs to someone else
    \item \textbf{The activity}: the work itself is not yours to direct
    \item \textbf{Species-being}: free, creative production is what makes us human---so degraded work degrades us
    \item \textbf{Other people}: workers meet as competitors rather than collaborators
\end{enumerate}
\end{conceptbox}

\vspace{0.2em}
{\small \textbf{Why this matters for AI}: each has a contemporary echo. Who owns the output of an AI-assisted worker? Who sets the pace when an algorithm assigns the tasks? Is prompting still creative production?

\vspace{0.15em}
\textbf{Note the disagreement}: for Marx the problem is who \emph{owns} the process; for Arendt it is what the activity \emph{is}.}

\begin{discussionbox}[Discussion]
Take a job you have actually held. Which of the four alienations applied---and was the pay enough to make up for it?
\end{discussionbox}
\end{frame}
...
\begin{frame}[shrink=8]{The Psychology of Meaningful Work}
\begin{columns}[T]
...
\begin{discussionbox}[Discussion]
Name the most meaningful work you have done. Were you \textbf{paid} for it? What does the answer suggest about how we assign wages?
\end{discussionbox}
\end{frame}
...
\begin{itemize}
  \item Jacquard's \textbf{punched-card} loom (1804) could replace \textbf{several skilled weavers}
  \item Inspired Babbage's \textbf{Analytical Engine}---and thus modern computing
  \item Lovelace: it ``weaves algebraic patterns as the loom weaves flowers''
\end{itemize}
\end{block}
\begin{exampleblock}{The Parallel}
\small Automation of \textbf{physical craft} then, of \textbf{cognitive work} now---the ethical questions are the same.
\end{exampleblock}
\end{column}
\begin{column}{0.47\textwidth}
\begin{figure}
...
\vspace{0.2em}
\textbf{Deskilling} is not new. \textcite{braverman_labor_monopoly} argued that industrial management systematically breaks skilled trades into simple, monitorable steps---cheaper to staff, easier to control, and emptier to perform.
...
\end{frame}
% ===== YOU BE THE JUDGE =====
\begin{frame}[shrink=8]{You Be the Judge: The Automation Memo}
\begin{casestudybox}[On your desk Monday]
\small
You run a 200-person claims office. A vendor demo shows a system that handles about \textbf{70\% of routine claims} end to end. Finance has costed the layoffs. Operations wants to redeploy people to the hard 30\%. HR wants a six-month pilot.
\end{casestudybox}

\textbf{You have to pick one.} Then answer the follow-up:
\begin{itemize}
    \item \textbf{Cut 60 jobs} --- the savings are real and your competitors will take them if you do not
    \item \textbf{Redeploy} --- keep everyone, move them onto the cases the system cannot do
    \item \textbf{Pilot} --- six months, decide later, and accept that ``later'' usually means the first option
\end{itemize}

\begin{discussionbox}[The follow-up]
You just chose one of \textbf{replacement, deskilling, or augmentation} without naming it. Which one? And would the workers describe your choice the same way you just did?
\end{discussionbox}
\end{frame}
...
\begin{frame}[shrink=8]{The Problem of ``Bullshit Jobs''}
...
\begin{discussionbox}[Discussion]
If a job feels pointless to the person doing it but the employer keeps paying for it, \textbf{who is wrong about its value}---and how would you tell?
\end{discussionbox}
\end{frame}
...
\begin{frame}[shrink=8]{The Stakes for Human Artists}
...
\begin{discussionbox}[Discussion]
Would you rather live in a world with \textbf{more art} that nobody struggled to make, or \textbf{less art} that someone did? Be honest about the trade.
\end{discussionbox}
\end{frame}
