...
\vspace{0.15cm}
\textbf{Where things stand} (mid-2026):
\begin{itemize}
    \item More than a dozen suits against OpenAI and Microsoft consolidated as an \textbf{MDL} in the Southern District of New York
    \item Anthropic's \textbf{\$1.5 billion} class settlement---the largest in US copyright history---received final approval in July 2026
    \item \textbf{No federal appeals court has yet ruled} on AI training and fair use; the first to hear the question was argued in June 2026 and is undecided
\end{itemize}
