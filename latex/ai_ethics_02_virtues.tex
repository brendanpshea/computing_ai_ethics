...
\begin{itemize}
  ...
  \item Depicts the great thinkers of antiquity gathered in an idealized Athens
  \item \textbf{Center}: Plato (pointing up---Ideal Forms) and Aristotle (hand level---observation)
  \item Their \textbf{gestures} symbolize their philosophical difference: abstract vs.\ empirical
\end{itemize}
\end{block}
\begin{exampleblock}{The Contrast}
\small Plato's ethics flows from ideal Forms; Aristotle's from observing how virtuous people actually live and practice character.
\end{exampleblock}
\end{column}
\begin{column}{0.47\textwidth}
\begin{figure}
