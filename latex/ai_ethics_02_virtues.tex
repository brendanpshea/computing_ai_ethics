...
\vspace{0.2cm}
\begin{quotebox}[Will Durant, summarizing Aristotle's \textit{Nicomachean Ethics} \parencite{durant_story_philosophy}]
...
Early evidence (regulator's July 2026 evaluation) on the first under-16 ban:
...
\begin{itemize}
    ...
    \item Public support \textbf{rose} to roughly 77\% of adults
    \item The UK and others copied it; France's court \textbf{struck down} its version (2026)
\end{itemize}
\end{probox}
\end{column}
\begin{column}{0.48\textwidth}
...
\scriptsize
\begin{itemize}
    \item Usage fell only from \textbf{85.9\% to 81.5\%}; accounts from \textbf{52\% to 42\%}
    \item A UK charity's poll: \textbf{70\%} found circumvention ``easy''
    \item \textbf{No fines} yet; five platforms under investigation
\end{itemize}
\end{objectionbox}
\end{column}
\end{columns}
