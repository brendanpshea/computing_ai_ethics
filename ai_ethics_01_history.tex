...
%------------------------------------------------------
% SLIDE 10: Plato's Phaedrus: An Ancient Critique of Writing Technology
%------------------------------------------------------
\begin{frame}{Plato's \textit{Phaedrus}: An Ancient Critique of Writing Technology}
    \begin{itemize}
        \item \textbf{Plato} (c.\ 428--348 BCE) was an Athenian philosopher who recorded his teacher Socrates's ideas in philosophical dialogues.
        \item In the \textit{Phaedrus} (c.\ 370 BCE), Socrates tells a myth: the Egyptian god Theuth invents writing and presents it to King Thamus as a gift to improve memory and wisdom.
        \item King Thamus rejects it, warning that writing will create \textbf{external dependence}---people will trust symbols ``which are no part of themselves'' instead of cultivating internal memory.
        \item Socrates argues writing produces the \textbf{appearance of wisdom without the reality}: readers will ``appear to be omniscient'' while actually knowing nothing deeply.
        \item Unlike a living teacher, a written text cannot respond to questions or adapt to different learners---it ``preserves a solemn silence.''
    \end{itemize}
...
%------------------------------------------------------
% SLIDE 11: The Irony: We Only Know This Because Plato Wrote It Down
%------------------------------------------------------
...
\begin{frame}{The Second Revolution: The Printing Press}
    \begin{itemize}
        ...
        \item \textbf{Johannes Gutenberg} (c.\ 1400--1468) developed \textbf{movable type} printing in Mainz, Germany around 1450, combining existing technologies into a system for mass production.
        \item Gutenberg integrated the screw press (from wine-making), oil-based ink, and metal alloy letter molds to produce thousands of identical characters that could be arranged and rearranged.
        \item The \textbf{Gutenberg Bible} (c.\ 1455) demonstrated that printed books could match manuscript quality, launching a revolution that would reshape religion, science, politics, and culture.
    \end{itemize}
...
%------------------------------------------------------
% SLIDE 16: The Impact: Books Become Cheap and Abundant
%------------------------------------------------------
\begin{frame}{The Impact: Books Become Cheap and Abundant}
    \begin{itemize}
        \item Before printing, a single book might cost as much as a house---each copy required months of labor by trained scribes in monastery scriptoriums.
        \item The printing press reduced book costs by approximately 80\% within its first century, making written knowledge accessible to merchants, professionals, and eventually ordinary citizens.
        \item By 1500---just 50 years after Gutenberg---an estimated 20 million books had been printed across 250+ European cities, surpassing all manuscripts produced in the previous thousand years.
...
%------------------------------------------------------
% SLIDE 18: Two Philosophers of the Printing Press: Erasmus and Luther
%------------------------------------------------------
\begin{frame}{Two Philosophers of the Printing Press: Erasmus and Luther}
    \begin{itemize}
        \item \textbf{Desiderius Erasmus} (c.\ 1466--1536) and \textbf{Martin Luther} (1483--1546) were the two most widely read authors of the early print era---and corresponded with each other about reform and the power of print.
        \item Both championed vernacular Bibles and criticized Church corruption, but they disagreed fundamentally about \textit{how} print should be used and \textit{who} should read what.
        \item \textbf{Erasmus}: Believed print should serve \textbf{gradual reform} through scholarly dialogue in the ``Republic of Letters''---education and reason would peacefully persuade elites to change.
        \item \textbf{Luther}: Believed print should enable \textbf{immediate revolution} by bypassing gatekeepers entirely---short, vernacular pamphlets could reach ordinary people and spark mass action.
    \end{itemize}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{p{2.8cm}p{3.8cm}p{3.8cm}}
            \toprule
            & \textbf{Erasmus} & \textbf{Luther} \\
            \midrule
            Audience & Educated elites & Common people \\
            Strategy & Gradual reform & Immediate revolution \\
            Tone & Irony, moderation & Passion, confrontation \\
            Format & Letters, scholarly editions & Pamphlets, vernacular texts \\
            Goal & Republic of Letters & Mass mobilization \\
            Legacy & Intellectual dialogue & Protestant Reformation \\
            \bottomrule
        \end{tabular}
    \end{table}
\end{frame}
...
\end{frame}
%------------------------------------------------------
% SLIDE 32: World War I: The End of the Long Nineteenth Century
%------------------------------------------------------
\begin{frame}{World War I: The End of the Long Nineteenth Century}
    \small
    \begin{itemize}
        \item World War I (1914--1918) shattered the optimism of the ``long nineteenth century''---the hope that technologies like the telegraph and telephone would bring understanding, peace, and progress.
        \item Instead, these same technologies enabled unprecedented coordination of industrial warfare: generals commanded armies across continents in real time, killing approximately 20 million people.
        \item Governments created the first modern \textbf{propaganda agencies}, using mass newspapers, posters, and film to demonize enemies and suppress dissent---proving that faster communication does not guarantee wiser decisions.
        \item The interception and decryption of the \textbf{Zimmermann Telegram} (1917) demonstrated that control over information could change history, bringing the United States into the war.
        \item Mill's faith in the ``marketplace of ideas'' and the Victorians' dream of technology-driven peace lay buried in the trenches of the Somme and Verdun.
    \end{itemize}
    
    \vspace{0.3em}
    
    \begin{alertblock}{The Lesson}
        The same technologies that promised to connect humanity and promote peace became tools of propaganda, manipulation, and mass death. Information technology amplifies human choices---both noble and terrible.
    \end{alertblock}
\end{frame}
...
\begin{frame}{What IT Was Used in Making This Course?}
    \begin{itemize}
        \item The tools used to make and record these lectures provide a practical example of the history we've discussed.
        \item I've used:
        \begin{itemize}
            \item Written English (the first IT revolution).
            \item LaTeX (a typesetting system developed in the 1980s, building on decades of digital typography).
            \item A digital video camera and microphone (tools for capturing audiovisual information).
            \item VSCode (a modern code editor) to write and compile the LaTeX source files. 
            \item I used generative AI (CoPilot, Claude, Gemini) to help me write LaTeX code, generate graphics, proofread, and format the slides.
            \item A laptop computer to run all these tools and connect to the internet.
            \item I used GitHub to version-control the source files and collaborate with others.
            \item This is delivered in Web 2.0 teaching platfrorms (D2L, YouTube, Perusall) that allow for interaction, comments, and updates.
        \end{itemize}
        \item Each of these tools has a history and ethical implications we could analyze using the frameworks we've discussed.
    \end{itemize}
\end{frame}
