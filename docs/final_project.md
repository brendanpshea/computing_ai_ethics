...
Create a 15–20 minute video presentation on a topic, case study, or figure related to computing and AI ethics. You may go deeper on something we covered in class, explore an emerging issue, or choose a topic we haven't discussed.
...
- **3+ sources** with either working hyperlinks in the slides or PDFs attached to your submission (Wikipedia and similar non-scholarly sites do not count)
...
| Category | Points |
|---|---|
| **Content** — accuracy, depth, use of sources, clear argument or narrative | 10 |
| **Presentation quality** — organization, visuals, delivery, meets time requirement | 10 |
