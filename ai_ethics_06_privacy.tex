...
% Slide 10: Nothing to Hide Argument
...
% Slide 12: Case Study - Right to Be Forgotten
...
\small
\begin{enumerate}
    \item \textbf{Comprehensiveness}: Multiple overlapping systems
    \item \textbf{Integration}: Linking databases for complete profiles
    \item \textbf{Automation}: AI enables scale impossible with human monitors
    \item \textbf{Normalization}: Gradual expansion of acceptable surveillance
    \item \textbf{Chilling effects}: Self-censorship without direct enforcement
\end{enumerate}
\end{conceptbox}
...
% Slide 31: Arguments FOR Surveillance
\begin{frame}{Arguments FOR Surveillance (Security Perspective)}
\begin{probox}[Pro-Surveillance Arguments]
\small
\begin{enumerate}
    \item \textbf{Crime prevention}: Deterrence through visibility
    \item \textbf{Crime solving}: Evidence for prosecution
    \item \textbf{Terrorism prevention}: Identifying threats before attacks
    \item \textbf{Public safety}: Finding missing persons, emergency response
    \item \textbf{Efficiency}: Faster, more accurate than human observation
    \item \textbf{Consent}: Public spaces have no expectation of privacy
\end{enumerate}
\end{probox}

\vspace{0.2em}
\textbf{Common refrain}: ``If you've got nothing to hide, you've got nothing to fear''
\end{frame}

% Slide 32: Arguments AGAINST Surveillance
\begin{frame}{Arguments AGAINST Surveillance (Liberty Perspective)}
\begin{objectionbox}[Anti-Surveillance Arguments]
\small
\begin{enumerate}
    \item \textbf{Chilling effects}: People self-censor when watched
    \item \textbf{Power asymmetry}: Government sees citizens, not reverse
    \item \textbf{Mission creep}: Systems expand beyond original purpose
    \item \textbf{Function creep}: Data used for unintended purposes
    \item \textbf{Error rates}: False positives harm innocent people
    \item \textbf{Bias}: Algorithms encode and amplify discrimination
    \item \textbf{Abuse potential}: Tools \emph{will} be misused (history shows this)
\end{enumerate}
\end{objectionbox}

\vspace{0.2em}
\textbf{Neil Richards}: ``A society in which everyone is watched by everyone else is less a utopia than a nightmare.''
\end{frame}

% Slide 33: Facial Recognition Debate
...
\textbf{Criticisms}:
\begin{itemize}
    \item \textbf{Feedback loops}: Police go where predicted $\rightarrow$ more arrests $\rightarrow$ more predictions
    \item \textbf{Historical bias}: Trained on biased enforcement data
    \item \textbf{Pre-crime problem}: Punishing predicted future acts
    \item \textbf{Opacity}: Proprietary algorithms can't be challenged
    \item \textbf{Efficacy}: Limited evidence it actually reduces crime
\end{itemize}

\textbf{Case}: Los Angeles ended PredPol (2020) after bias concerns
\end{frame}

% Slide 36: Workplace Surveillance
...
% Slide 37: Sophisticated Response to Nothing to Hide
...
\begin{enumerate}
    ...
    \item \textbf{Contextual integrity}: Info appropriate in one context isn't in another
    \item \textbf{Aggregation}: Combining innocuous data reveals sensitive information
    \item \textbf{Chilling effects}: Even innocent people change behavior
    \item \textbf{Power}: ``Show me yours first'' (government transparency)
    \item \textbf{Equality}: Surveillance falls disproportionately on marginalized groups
\end{enumerate}
\end{objectionbox}
...
% Slide 38: Frameworks for Democratic Surveillance
\begin{frame}{Possible Frameworks for Democratic Surveillance}
\begin{conceptbox}[Constraints for Democratic Surveillance]
\small
\begin{enumerate}
    \item \textbf{Judicial oversight}: Warrants required, meaningful review
    \item \textbf{Transparency}: Public knows what systems exist
    \item \textbf{Purpose limitation}: Only for specified uses
    \item \textbf{Minimization}: Collect only what's necessary
    \item \textbf{Retention limits}: Delete after time period
    \item \textbf{Audit trails}: Record who accesses what
    \item \textbf{Accountability}: Consequences for misuse
    \item \textbf{Sunset clauses}: Programs expire without reauthorization
\end{enumerate}
\end{conceptbox}
\end{frame}

% Slide 39: Key Tensions
