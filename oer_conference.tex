...
\setbeamertemplate{frame footer}{\textcolor{black!40}{\tiny Computing \& AI Ethics --- OER Conference 2026}}
...
\subtitle{An Open Educational Resource for Gen Ed | OER Conference 2026}
...
\begin{itemize}
  \item \textbf{Rochester Community and Technical College} is a two-year college in Rochester, MN---home of the Mayo Clinic---serving a largely first-generation student population.
  \item I hold a joint appointment in \textbf{Philosophy} and \textbf{Computer Science}, teaching from Intro Logic to Networking to Cybersecurity.
...
\begin{block}{Courses I Teach}
\footnotesize
\begin{itemize}
  \item PHIL 1150 --- Computing \& AI Ethics
  \item COMP 2243 --- Programming \& Problem Solving
  \item COMP 1080 --- Intro to Networking
  \item Cybersecurity electives
\end{itemize}
\end{block}
\vspace{0.3em}
...
\begin{itemize}
  ...
  \item Every student will make consequential decisions \emph{as a citizen, worker, and consumer} shaped by AI and digital systems, regardless of major.
...
\begin{itemize}
  ...
  \item Open and freely adaptable resources lower barriers at institutions with limited budgets and adjunct-heavy staffing.
\end{itemize}
\column{0.34\textwidth}
