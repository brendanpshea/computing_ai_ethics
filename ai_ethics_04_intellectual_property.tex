...
% Lecture 4 color theme (intellectual property)
...
\setbeamercolor{structure}{fg=ipblue}
\setbeamercolor{title}{fg=white,bg=ipblue}
\setbeamercolor{frametitle}{fg=white,bg=ipblue}
\setbeamercolor{block title}{fg=white,bg=ipblue}
\setbeamercolor{block body}{bg=ipblue!10}
...
\section{Part II: The Digital Transformation}
...
\mode<article>{
Critical IP scholars like Peter Drahos, Cory Doctorow, and Tim Wu argue that contemporary IP law often serves concentrated corporate power rather than its stated goals of promoting innovation and creativity. Draho's "information feudalism" describes how IP has been globalized through trade agreements to benefit wealthy countries and large corporations at developing nations' expense. Doctorow's "chokepoint capitalism" shows how platforms use IP to maintain bottleneck control over markets. Case studies including Disney's copyright extensions, pharmaceutical patent abuses, and patent trolls demonstrate how IP can become a tool for rent-seeking rather than innovation.
}
...
\section{Part IV: Big Tech and Platform IP}
...
\section{Part VI: Open Source and Alternative Models}
