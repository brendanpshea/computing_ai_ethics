...
% ===== SLIDE 1: Title =====
{%
\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{images/fractal_04.png}}%
\begin{frame}
\titlepage
\end{frame}
}
...
\begin{itemize}
  ...
  \item Pioneered the \textbf{industrial research lab} at Menlo Park---``invention factory''
  \item Inventions: phonograph, practical incandescent bulb, motion picture camera
  \item Became embroiled in the \textbf{``War of Currents''} patent battles with Tesla/Westinghouse
\end{itemize}
\end{block}
\begin{exampleblock}{The IP Question}
\small Did Edison's patents protect genuine innovation---or lock down technologies that others could have improved faster?
\end{exampleblock}
\end{column}
...
\begin{itemize}
  \item Physical property: If I take your \textbf{car}, you no longer have it
  \item Intellectual property: If I copy your \textbf{idea}, you still have it
  \item Ideas are \textbf{non-rivalrous}---sharing does not diminish them
  \item IP law creates \textbf{artificial scarcity} where none naturally exists
\end{itemize}
\end{block}
...
\section{Part I: Philosophical Foundations}
...
\subsection{Philosophical Justifications for IP Rights}

\section{Part II: Digital Disruption and Adaptation}
...
\section{Part III: Critiques and Abuses of IP}
...
\section{Part III: Market Power and Control}
...
\section{Part V: AI and Intellectual Property}
...
% ===== SECTION IV: OPEN SOURCE AND ALTERNATIVES =====

\section{Part IV: Beyond Traditional IP}
...
\subsection{Beyond Traditional IP: Alternatives and Innovations}
