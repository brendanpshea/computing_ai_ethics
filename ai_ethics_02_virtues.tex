...
% Lecture 2 color theme (virtue ethics)
...
\setbeamercolor{structure}{fg=aristotleblue}
\setbeamercolor{title}{fg=white,bg=aristotleblue}
\setbeamercolor{frametitle}{fg=white,bg=aristotleblue}
\setbeamercolor{block title}{fg=white,bg=aristotleblue}
\setbeamercolor{block body}{bg=aristotleblue!10}
...
\section{Part II: Intellectual Virtues Under Threat}
...
\section{Part III: Moral Virtues Under Threat}
...
\section{Part IV: Eudaimonia Under Threat}
...
\section{Part V: Policy Responses}
...
\section{Part VI: Objections and Responses}
