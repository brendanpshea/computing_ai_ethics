...
\begin{tikzpicture}[scale=0.85, transform shape,
  ...
  \node[box, fill=accentgold!30] (part1) {Part I: The Virtue Ethics\\Tradition (Slides 5--15)};
  \node[box, below=of part1] (part2) {Part II: Social Media\\and AI (Slides 16--25)};
  \node[box, below=of part2, fill=primaryblue!25] (part3) {Part III: Virtue and\\Democracy (Slides 26--31)};
  \node[box, below=of part3] (part4) {Part IV: Are We Getting\\Worse? (Slides 32--37)};
  \node[box, below=of part4, fill=red!15] (part5) {Part V: Criticisms \&\\Conclusion (Slides 38--41)};
...
\vspace{0.2em}
\begin{alertblock}{Course Connection}
In future lectures, we'll examine specific issues (privacy, free speech, AI) with these virtue ethics tools in hand.
\end{alertblock}
\end{frame}
