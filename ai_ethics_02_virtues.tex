...
% ===== SLIDE 3: Aristotle's Ethical Framework =====
...
\begin{alertblock}{?}
Can you identify the mean between ``too much screen time'' and ``too little''?
\end{alertblock}
\end{frame}

% ===== SLIDE 6: Intellectual vs. Moral Virtues =====
...
% ===== SLIDE 8: Habituation and Moral Development =====
...
% ===== SLIDE 13: Intellectual Virtues Introduction =====
...
% ===== SLIDE 14: Argument in Standard Form (Intellectual) =====
...
% ===== SLIDE 15: Premise 1 - How Intellectual Virtues Are Cultivated =====
\begin{frame}{Premise 1: How Intellectual Virtues Are Cultivated}
Intellectual virtue requires \textbf{effortful practice}:

\begin{itemize}
    \item \textbf{Sustained attention}: Deep reading, focused study
    \item \textbf{Memory work}: Effortful encoding and retrieval
    \item \textbf{Confronting difficulty}: Struggling without immediate help
    \item \textbf{Diverse exposure}: Encountering challenging viewpoints
    \item \textbf{Slow thinking}: Deliberate reasoning over snap judgments
\end{itemize}
...
% ===== SLIDE 16: Premise 2a - The Attention Crisis =====
...
% ===== SLIDE 17: Premise 2b - Outsourcing Memory =====
\begin{frame}{Premise 2b: Outsourcing Memory and Cognition}
\textbf{Cognitive offloading}: Using technology as external memory

\begin{itemize}
    \item \textbf{``Google Effects on Memory''} (Sparrow et al., 2011): We remember \textit{where} to find information, not the information itself
    \item \textbf{GPS navigation}: Reduced spatial reasoning and mental mapping
    \item \textbf{AI writing tools}: Outsourcing composition and critical thinking
    \item \textbf{Calculators $\rightarrow$ AI}: The deskilling concern, now much deeper
\end{itemize}
...
% ===== SLIDE 18: Premise 2c - Echo Chambers =====
...
% ===== SLIDE 19: Premise 2d - AI and Intellectual Dependency =====
...
% ===== SLIDE 20: Synthesis - Intellectual Virtues =====
...
\begin{itemize}
    \item \textbf{Curated self-presentation}: Instagram vs. reality
    \item \textbf{Performative virtue}: Signaling goodness without being good
    \item \textbf{Deepfakes and synthetic media}: Truth becomes optional
    \item \textbf{AI-generated content}: Erosion of authentic communication
    \item Result: \textbf{Collapse of trust} in media, institutions, each other
\end{itemize}
...
\begin{itemize}
    ...
    \item Algorithm shows you ``more of what you like''---but is that \textit{you}?
    \item Loss of \textbf{narrative unity} (MacIntyre): Fragmented self
    \item \textbf{AI companions}: The illusion of being understood
\end{itemize}
