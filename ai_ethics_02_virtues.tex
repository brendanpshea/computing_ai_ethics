    ...
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            \begin{itemize}
                ...
                \item \textbf{Eudaimonia} is often translated as ``happiness,'' but is better understood as ``human flourishing'' or ``living well.''
...
\begin{frame}{Aristotelian Virtues for Social Media}
    ...
    \begin{block}{Key Insight from Susan Sauvé Meyer (Princeton)}
...
\begin{frame}{Communitarianism and Civic Virtue}
    ...
    \begin{block}{Michael Sandel on Civic Virtue}
        Democracy requires more than voting---it requires citizens with the \textbf{character} to engage respectfully with those who disagree, to seek common ground, and to place the common good above narrow self-interest.
    \end{block}
\end{frame}
...
\begin{frame}{MacIntyre, Practices, and the Common Good}
    \begin{itemize}
        \item Alasdair MacIntyre's \textit{After Virtue} (1981) warned that modern society has lost \textbf{shared frameworks} for moral reasoning.
...
% Social Media and the Virtues - Slides 13-16 (REVISED)
% PART 2: History and Technologies of Web 2.0
% Now with virtue ethics as analytical lens throughout
...
\begin{frame}{Technology and the Virtues}
    \begin{itemize}
        ...
        \item Philosopher \textbf{Shannon Vallor} argues that technologies are not neutral tools---they \textbf{shape the conditions} under which virtues can (or cannot) flourish.
...
\begin{frame}{Core Characteristics Through a Virtue Lens}
    ...
    \begin{alertblock}{Sherry Turkle's Warning}
        ``We expect more from technology and less from each other.'' Digital connection may \textbf{simulate} community without providing the sustained, embodied relationships where virtue actually develops.
    \end{alertblock}
\end{frame}
...
\begin{frame}{TIME Person of the Year 2006---Optimism and Concern}
    \begin{itemize}
        \item In 2006, \textbf{TIME Magazine} named ``You'' as Person of the Year, celebrating user-generated content and collaboration.
...
\begin{frame}{Echo Chambers and the Erosion of Civic Virtue}
    ...
    \begin{alertblock}{The Filter Bubble Problem}
        Eli Pariser (2011): Algorithms create ``\textbf{filter bubbles}'' that invisibly edit our view of the world. We lose the \textbf{common ground} necessary for democratic deliberation.
    \end{alertblock}
\end{frame}
...
\begin{frame}{Polarization and the Decline of Civic Friendship}
    ...
    \begin{block}{Evidence of Polarization}
        Pew Research (2024): The share of Americans with ``very unfavorable'' views of the opposing party has \textbf{more than doubled} since the 1990s. We increasingly see opponents as not just wrong, but as \textbf{threats to the nation}.
    \end{block}
\end{frame}
...
\begin{frame}{Turkle on Conversation, Empathy, and Citizenship}
    ...
    \begin{alertblock}{Research Finding}
        Studies suggest empathy among college students has \textbf{declined 40\%} since 2000. This affects not just personal relationships but our capacity for democratic life with diverse others.
    \end{alertblock}
\end{frame}
...
\begin{frame}{Sleep, Patience, and Self-Control}
    \begin{itemize}
        \item Research shows \textbf{nighttime social media use} is associated with poor sleep, anxiety, and depression (Woods \& Scott, 2016).
...
\begin{frame}{The Challenge of Developing Phronesis}
    \begin{itemize}
        ...
        \item Orben \& Przybylski found small average effect sizes---but averages obscure the \textbf{individual differences} that phronesis must navigate.
...
\begin{frame}{Framing the Debate---Character and Resilience}
    \begin{itemize}
        \item Jonathan Haidt's \textit{The Anxious Generation} (2024) can be understood as a claim about \textbf{virtue formation}.
...
\begin{frame}{The Critics---Questioning the Causal Story}
    \begin{itemize}
        \item \textbf{Candace Odgers} (\textit{Nature}) argues Haidt confuses correlation with causation---a failure of \textbf{intellectual humility}.
...
\begin{frame}{Research Quality and Epistemic Virtue}
    \begin{itemize}
        \item Critics like \textbf{Aaron Brown} and \textbf{Andrew Przybylski} argue that most studies Haidt cites have significant methodological weaknesses.
